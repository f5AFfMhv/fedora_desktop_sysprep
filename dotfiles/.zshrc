...
# enabled hosts.
zstyle ':z4h:ssh:*' send-extra-files '~/.env.zsh' '~/.vimrc' '~/.alias.zsh' '~/.vim'
...
if [ -f '~/google/cloud/google-cloud-sdk/path.zsh.inc' ]; then . '~/google/cloud/google-cloud-sdk/path.zsh.inc'; fi
